...
public class MainMenu extends EnterChoice {
    ...
    public int show() {
        ...
        while (mainMenuChoice != 1
            ...
            if (mainMenuChoice == 0) {
                descriptionExit();
                break;
            } else if (mainMenuChoice < 0 || mainMenuChoice > 4) {
                System.out.println("--------------------------");
                System.out.println("Enter the number of your choice from '0' to '4'");
    ...
    private void descriptionMainMenu() {
        ...
        System.out.println("3. Last 3 results of calculating");
        System.out.println("4. ALL results of calculating");
